	...
	<div class="footer-nav-widgets-wrapper header-footer-group">
		...
		<div class="footer-inner section-inner">
			...
			if ( $has_footer_menu || $has_social_menu ) {
				?>
				<div class="footer-top <?php if(!is_front_page()):?>social-bg<?php endif;?> <?php echo $footer_top_classes; //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- static output ?>">
